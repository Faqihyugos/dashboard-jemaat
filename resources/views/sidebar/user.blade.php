        ...
        <div class="sidebar-header">
            <div class="d-flex justify-content-between">
                <div class="text-center">
                    <h4><a href="{{ route('home') }}">Sistem Informasi Jemaat</a></h4>
                </div>
                <div class="toggler">
            ...
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    <a href="#" class='sidebar-link'>
                        ...
                        <span>Form Jemaat</span>
                    </a>
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="{{ route('jemaat.create') }}">Input Jemaat</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item  has-sub">
                    <a href="#" class='sidebar-link'>
                        ...
                        <span>View Table Jemaat</span>
                    </a>
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="{{ route('jemaat.index') }}">View Table</a>
                        </li>
                    </ul>
                </li>
